...
module.exports.storage = {
  data: {
    ...
    moderation: {
      delete: async (guild) => {
        await deleteGuildData(guild, 'moderation');
      },
      get: async (guild) => {
        let res = await readGuildData(guild, 'moderation'); return res;
      },
      set: async (guild, data) => {
        let res = await saveGuildData(guild, 'moderation', data); return res;
      }
    },
    voice: {
      delete: async (guild) => {
        await deleteGuildData(guild, 'voice');
      },
      get: async (guild) => {
        let res = await readGuildData(guild, 'voice'); return res;
      },
      set: async (guild, data) => {
        let res = await saveGuildData(guild, 'voice', data); return res;
      }
    },
    trackers: {
      delete: async (guild) => {
        await deleteGuildData(guild, 'trackers');
      },
      get: async (guild) => {
        let res = await readGuildData(guild, 'trackers'); return res;
      },
      set: async (guild, data) => {
        let res = await saveGuildData(guild, 'trackers', data); return res;
      }
    }
  },
  settings: {
