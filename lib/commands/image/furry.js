...
const endpoints = require('../../assets/resources/furryEndpoints.json');
  ...
  async execute(interaction, client) {
    ...
    function getFurryImg(endpoint) {
      ...
      if (data.nsfw) {
        ...
        try {
          title = data.titles[randomizer(data.titles.length)];
          desc = data.descriptions[randomizer(data.descriptions.length)];
